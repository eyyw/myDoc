...
Clipboard := RegExReplace(Clipboard, "\t", "")
Clipboard := RegExReplace(Clipboard, "\r\n", "")
Clipboard := RegExReplace(Clipboard, "ooh", "受注ヘッダ")
Clipboard := RegExReplace(Clipboard, "ool", "受注明細")
